<?php
  ...
  if(isset($_POST['signup'])){
    ...
    if($check>0){
        ...
        mysqli_query($con,"INSERT INTO `user`(`name`, `email`, `password`, `date`) VALUES ('$name','$email','','$added_on')");
        ?>
        <script>
            alert('Sucessfully Registered! Check Your email for admin accept and OTP code');
        </script>
        <?php
    }
  }
